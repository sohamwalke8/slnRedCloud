...
{
    public class GetOrganizationReportQueryHandler : IRequestHandler<GetOrganizationReportQuery, Response<IEnumerable<OrganizationReportVM>>>
    {
        ...
        public GetOrganizationReportQueryHandler(IAsyncRepository<ResellerInboundMessagesReport> reportRepository, IMapper mapper, ILogger<GetOrganizationReportQueryHandler> logger)
        {
        ...
        public async Task<Response<IEnumerable<OrganizationReportVM>>> Handle(GetOrganizationReportQuery request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var reportData = await _reportRepository.StoredProcedureQueryAsync("GetAllOrganizationDetailsWithStatus");
